...
import com.NASB.TuitionMedia.R;

@SuppressWarnings("deprecation")
public class TTab_Main extends TabActivity {
	String Ph = "df"; 
	Intent intent;  
	Editor editor;
	Context context;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ttutor_tab);
		...
		//setting up tutor tab  
		 ...
		 Intent mapIntent = new Intent(this,TMap.class);
		 ...
		 Intent addIntent = new Intent(this, Tutor_Add.class);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		switch (item.getItemId()) {
	        ...
	        case R.id.About:
	        	...
	        	Intent in= new Intent(TTab_Main.this,About.class);
	        	startActivity(in);
	        	break;
